...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\"u\n" +
	...
	"\n" +
	"updated_at\x18\a \x01(\x03R\tupdatedAt2\xf3\x01\n" +
	"\vUserService\x129\n" +
	...
	"\vGetUserList\x12\x18.user.GetUserListRequest\x1a\x19.user.GetUserListResponseB\fZ\n" +
...
var file_user_user_proto_goTypes = []any{
	...
	(*GetUserListRequest)(nil),  // 6: user.GetUserListRequest
	(*GetUserListResponse)(nil), // 7: user.GetUserListResponse
	(*User)(nil),                // 8: user.User
}
var file_user_user_proto_depIdxs = []int32{
	8, // 0: user.GetUserListResponse.users:type_name -> user.User
	0, // 1: user.UserService.Register:input_type -> user.RegisterRequest
	2, // 2: user.UserService.Login:input_type -> user.LoginRequest
	4, // 3: user.UserService.Logout:input_type -> user.LogoutRequest
	6, // 4: user.UserService.GetUserList:input_type -> user.GetUserListRequest
	...
	7, // 8: user.UserService.GetUserList:output_type -> user.GetUserListResponse
